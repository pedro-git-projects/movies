...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "dsn", "postgres://pedro:"+password+"@localhost/go_movies?sslmode=disable", "Postgres connection string")
...
var password string = environmentVariable("PASSWORD")
